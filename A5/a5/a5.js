...
// posyTexture = textureLoader.load( "images/ABCD.jpg" );
// posyTexture = textureLoader.load( "images/ABCD.jpg" );
...
// negyTexture = textureLoader.load( "images/ABCD.jpg" );
...
var myMaterial = new THREE.ShaderMaterial( {
    ...
    vertexShader: document.getElementById( 'myVertShader' ).textContent,
    fragmentShader: document.getElementById( 'myFragShader' ).textContent
} );
...
// my floor
/////////////////////////////////////////////////////////////////////////
myGeometry = new THREE.PlaneBufferGeometry(4,4);
my = new THREE.Mesh(myGeometry, myMaterial);
my.position.x = -6.0;
my.position.z = 4.0;
my.position.y = -1.0;
